...
@Action(id = "ebcdicToAscii", name = "EBCDIC To ASCII Converter", description = "Convert text from the EBCDIC to the ASCII character set", tags = {"extension"})
public class EbcdicToAsciiAction implements Step {

  @ConfigurationProperty(
          name = "charset",
          displayName = "Charcter set",
          description = "The type of EBCDIC charcter set to use",
          type = "String",
          required = true,
          enums = {
